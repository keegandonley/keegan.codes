...
The first one is a bit obvious, but the world of software is not without abbreviations. There are a number of abbreviations that are baked into languages
...
> time it could be confused for "minutes," but in this context there's not much room for confusion.
