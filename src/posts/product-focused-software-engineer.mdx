...
export const description =
  'Job descriptions and titles can be tricky! For the last few years, I\'ve called myself a "product-focused software engineer." What does that mean to me?';
...
export const bskyThreadId = '3lqsskjrpu22r';
