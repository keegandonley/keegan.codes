...
It's a simple application that lets you build a list of ingredients on-hand, and then uses an LLM to come
up with one beverage that can be made with a subset of those ingredients.

![](thirsty-bot:example-ui.png)

Here's one of my favorite drinks, created from my list of ingredients, along with an
enticing photo!
...
some strange results, but it's fun nontheless to see what can be made with a collection of what I have
available!
