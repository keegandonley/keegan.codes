...
export const tags = ['javascript', 'react', 'nextjs', 'software', 'ai'];
...
<video width="2880" height="1594" controls preload="metadata">
  <source
...
<video width="3950" height="2304" controls preload="metadata">
  <source
