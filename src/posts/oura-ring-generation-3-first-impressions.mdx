...
export const shortCodes = ["fitness", "gadget", "hobby"];
...
![Black ring on the left in the generation 3 with the black PCB, and the silver right on the right is the generation 2 with green PCB](oura-post:image-6.png "Ring Comparison")
