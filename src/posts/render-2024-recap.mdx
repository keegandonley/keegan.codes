...
Dan talked about creating *your* design system, not just *a* design system. Sometimes, it can be valuable
...
Gall's Law came up too, which states that *"All complex systems that work evolved from simpler systems that worked"*. In short,
...
We also learned about picking a system that gets your org excited. Maybe that's a component library in Storybook,
or maybe it's a simple set of the design guidelines. Maybe it's even as simple as a defined process for design - 
