...
export const description =
  '10,000 lines of code per day. 6,700 lines per day. 1 billion lines per day. Do these numbers indicate anything meaningful at all? Why are we chasing bigger numbers?';
