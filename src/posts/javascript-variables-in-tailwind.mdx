...
This looks great, because the className is static and can be easily parsed. This approach starts to break down if you're using content from another
...
The inline style is only used to set the CSS variable, which is then used in the Tailwind class!
