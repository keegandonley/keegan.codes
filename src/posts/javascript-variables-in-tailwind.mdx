...
I've developed while building a component library at [Kizen](https://keegan.codes/blog/beginning-a-new-chapter-of-my-career-with-kizen) and migrating to Tailwind from a css-in-js approach.

Before we get started, I want to acknowledge that Tailwind can be a bit
polarizing within the web development community. I've built many sites [using Tailwind](https://keegan.codes/blog/deciding-on-a-custom-template-for-bootstrapping-nextjs-apps),
and [many without](https://keegan.codes/blog/welcome-to-my-new-blog), but this post isn't about whether or not you should use Tailwind - that's
for you to decide!
