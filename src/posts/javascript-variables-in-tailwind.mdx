...
export const tags = ["javascript", "css", "tailwind"];
...
Tailwind is a CSS utility framework that provides shorthand classes for rapidly composing
designs. Instead of writing CSS rules, you simply add utility classes to your element. Take
this simple element and some styling:
